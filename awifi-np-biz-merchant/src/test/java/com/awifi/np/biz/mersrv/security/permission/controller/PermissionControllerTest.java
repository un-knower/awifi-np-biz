package com.awifi.np.biz.mersrv.security.permission.controller;
...
public class PermissionControllerTest {
   ...
   /* @Test(expected=BizException.class)
    ...
    public void pushForAm() throws Exception{
        PowerMockito.when(SysConfigUtil.getParamValue("servicecode_merchant")).thenReturn("servicecode");
        PowerMockito.when(SysConfigUtil.getParamValue("servicekey_merchant")).thenReturn("servicekey");
        ...
        SysConfigUtil.getParamValue("servicekey_merchant");
    }
}
