package com.awifi.np.biz.statsrv.security.permission.controller;
...
public class PermissionController extends BaseController {
    ...
    public Map<String,Object> check(
        ...
        String serviceCode = SysConfigUtil.getParamValue("servicecode_stat");//服务代码[外键]
        //从redis中获取
    ...
    public Map<String,Object> pushForAm() throws Exception{
        ...
        String serviceKey = SysConfigUtil.getParamValue("servicekey_stat");//从配置表读取服务密钥
