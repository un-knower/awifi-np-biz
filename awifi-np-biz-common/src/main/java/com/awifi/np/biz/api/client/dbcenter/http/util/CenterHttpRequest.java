 ...
 * 版本：  v1.0
 * 功能：调用数据中心http接口，封装token逻辑
 * 修改记录：
 */
@SuppressWarnings("unchecked")
public class CenterHttpRequest {
     ...
     * @date 2017年1月18日 下午8:07:26
     */
    public static Map<String, Object> sendPutRequest(String path, String params){
        long beginTime = System.currentTimeMillis();
        String url = null;
        ByteBuffer byteBuffer = null;
        Map<String, Object> resultMap = null;
    ...
    private static Map<String, Object> formatByteBufferToMap(String interfaceUrl, String interfaceParam, ByteBuffer byteBuffer) throws Exception {
        ...
        Boolean suc = (Boolean) resultMap.get("suc");
        if(suc == null || !suc){
            throw new InterfaceException((String)resultMap.get("msg"), interfaceUrl, interfaceParam, returnMessage);
        }
        return resultMap;
    }
