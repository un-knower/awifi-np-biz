...
public class PermissionControllerTest {
   ...
   /* @Test(expected=BizException.class)
    ...
    public void pushForAm() throws Exception{
        PowerMockito.when(SysConfigUtil.getParamValue("servicecode_app")).thenReturn("servicecode");
        PowerMockito.when(SysConfigUtil.getParamValue("servicekey_app")).thenReturn("servicekey");
        ...
        SysConfigUtil.getParamValue("servicecode_app");
        SysConfigUtil.getParamValue("servicekey_app");
    }
}
