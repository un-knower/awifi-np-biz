...
public class PermissionControllerTest {
    ...
    public void pushForAm() throws Exception{
        PowerMockito.when(SysConfigUtil.getParamValue("servicecode_timebuy")).thenReturn("servicecode");
        PowerMockito.when(SysConfigUtil.getParamValue("servicekey_timebuy")).thenReturn("servicekey");
