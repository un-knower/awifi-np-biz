package com.awifi.np.biz.timebuysrv.menu.controller;
...
public class MenuController extends BaseController{
    ...
    public Map getListByParam(HttpServletRequest request,@RequestParam(value="access_token",required=true)String access_token){
        String serviceCode = SysConfigUtil.getParamValue("servicecode_timebuy");//从配置表读取服务代码
    ...
    public Map<String,Object> batchAddRoleMenuForAm(
        ...
        String serviceCode = SysConfigUtil.getParamValue("servicecode_timebuy");//服务编号
