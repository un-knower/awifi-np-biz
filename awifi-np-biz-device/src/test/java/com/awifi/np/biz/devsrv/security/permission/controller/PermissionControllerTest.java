package com.awifi.np.biz.devsrv.security.permission.controller;
...
public class PermissionControllerTest {
    ...
    public void pushForAm() throws Exception{
        PowerMockito.when(SysConfigUtil.getParamValue("servicecode_device")).thenReturn("servicecode");
        PowerMockito.when(SysConfigUtil.getParamValue("servicekey_device")).thenReturn("servicekey");
        ...
        SysConfigUtil.getParamValue("servicecode_device");
        SysConfigUtil.getParamValue("servicekey_device");
    }
}
