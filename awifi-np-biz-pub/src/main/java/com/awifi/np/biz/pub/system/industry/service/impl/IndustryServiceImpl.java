...
public class IndustryServiceImpl implements IndustryService {
     ...
     */
    public List<Map<String, String>> getListByParam(SessionUser sessionUser,String parentCode) throws Exception{
        String key;//redisKey
        Integer endIndex;//
        ...
        }else if(PermissionUtil.isMerchant(sessionUser)){//返回商户的行业信息
            Merchant merchant = MerchantClient.getById(sessionUser.getMerchantId());
            String industryId = merchant.getPriIndustryCode();
            String industryName = IndustryClient.getNameByCode(industryId);
            Map<String, String> industryMap = new LinkedHashMap<String, String>();
            industryMap.put("industryCode", industryId);
