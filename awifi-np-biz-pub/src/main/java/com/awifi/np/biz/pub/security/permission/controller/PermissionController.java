package com.awifi.np.biz.pub.security.permission.controller;
...
public class PermissionController extends BaseController {
    ...
    public Map<String,Object> check(
        ...
        String serviceCode = SysConfigUtil.getParamValue("servicecode_pub");//服务代码[外键]
        //从redis中获取
    ...
    public Map<String,Object> pushForAm() throws Exception{
        ...
        String serviceKey = SysConfigUtil.getParamValue("servicekey_pub");//从配置表读取服务密钥
     ...
     * @return 结果
     * @author 周颖  
     * @date 2017年5月9日 上午10:06:17
     */
    @ResponseBody
    @RequestMapping(method=RequestMethod.GET,value="/permissions")
    public Map<String,Object> getPermissionsByAccessToken(@RequestParam(value="access_token",required=true)String accessToken){
        ...
        String[] roleIdStrArray = roleIds.split(",");//将roleIds转换成字符串数组
        Long[] roleIdLongArray = CastUtil.toLongArray(roleIdStrArray);//字符串数组转Long数组
        List<Map<String,Object>> permissionList = permissionService.getPermissionsByRoleIds(roleIdLongArray);
        return this.successMsg(permissionList);
    }
}
