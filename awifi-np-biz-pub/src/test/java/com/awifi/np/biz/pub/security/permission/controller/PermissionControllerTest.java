...
//    }
    ...
    public void pushForAm() throws Exception{
        PowerMockito.when(SysConfigUtil.getParamValue("servicecode_pub")).thenReturn("servicecode");
        PowerMockito.when(SysConfigUtil.getParamValue("servicekey_pub")).thenReturn("servicekey");
        ...
        SysConfigUtil.getParamValue("servicecode_pub");
        SysConfigUtil.getParamValue("servicekey_pub");
    }
}
