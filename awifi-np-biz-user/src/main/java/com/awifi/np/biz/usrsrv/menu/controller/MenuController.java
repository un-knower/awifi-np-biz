package com.awifi.np.biz.usrsrv.menu.controller;
...
public class MenuController extends BaseController {
    ...
    public Map getListByParam(@RequestParam(value="access_token",required=true)String accessToken,HttpServletRequest request){
        String serviceCode = SysConfigUtil.getParamValue("servicecode_user");//配置表获取服务编号
    ...
    public Map<String,Object> batchAddRoleMenuForAm(
        ...
        String serviceCode = SysConfigUtil.getParamValue("servicecode_user");//服务编号
