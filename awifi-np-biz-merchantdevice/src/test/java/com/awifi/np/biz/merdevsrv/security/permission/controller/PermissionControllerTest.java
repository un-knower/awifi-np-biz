...
public class PermissionControllerTest {
    ...
    public void pushForAm() throws Exception{
        PowerMockito.when(SysConfigUtil.getParamValue("servicecode_merchantdevice")).thenReturn("servicecode");
        PowerMockito.when(SysConfigUtil.getParamValue("servicekey_merchantdevice")).thenReturn("servicekey");
        ...
        SysConfigUtil.getParamValue("servicecode_merchantdevice");
        SysConfigUtil.getParamValue("servicekey_merchantdevice");
    }
}
