package com.awifi.np.biz.projsrv.security.permission.controller;
...
public class PermissionControllerTest {
    ...
    */
    ...
    public void pushForAm() throws Exception{
        ...
        SysConfigUtil.getParamValue("servicecode_project");
        SysConfigUtil.getParamValue("servicekey_project");
    }
}
