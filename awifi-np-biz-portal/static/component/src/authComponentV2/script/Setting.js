                ...
                <div className="_Setting_">
                    <div className="form-group authModelConfig">
                        ...
                        <div className="col-sm-12 mobileArea">
                            ...
                            <input type="text" className="form-control resetInputWidth" value={ _state.message.mobileTitle } onChange={ this.handleMobileTitleChange } placeholder="请输入手机号认证标题"/>
                        ...
                        <div className="col-sm-12 typeArea">
                            ...
                            <input type="text" className="form-control resetInputWidth" value={ _state.message.userPassTitle } onChange={ this.handleUserPassTitleChange } placeholder="请输入用户名认证标题"/>&nbsp;&nbsp;&nbsp;
