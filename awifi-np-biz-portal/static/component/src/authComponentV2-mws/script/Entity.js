...
var _Entity_ = function (state, divId) {
    ...
    var stateDefault = {
        ...
        tabNum: 3,//tab数量
        //手机号
        mobileTitle: '手机号',//tab标签显示值
        hasMobile: true,//是否包含功能点：手机号认证
        hasQRCode: false,//是否包含功能点：二维码认证
        mobileLoginBtnSty: 'hide',//登录按钮是否显示
        hasMsgSend: false,//是否包含功能点：短信回发
        //用户名
        userPassTitle: '静态用户名',//tab标签显示值
        hasUserPass: true,//是否包含功能点：静态用户名认证
        //语音认证
        voiceTitle: '语音',//tab标签显示值
        hasVoice: true,//是否包含功能点：语音认证
        //免费上网
        freeButtonDsp: '登录上网',//按钮显示值

        hasFree: true,//是否包含功能点：免费上网
        hasAutoAuth: false, // 是否自动登录上网
        autoAuthSecond: 3,//自动登录上网-倒计时秒数
        //防蹭网
        openNetDef: false,//是否开通了防蹭网功能，true代表已经开通、false代表未开通
        //微信认证
        hasWechat: false,//是否显示微信认证组件，true 显示、 false 隐藏
        /** 修改密码、忘记密码 新增参数 */
        userName: '',//用户名
        mobile: '',//手机号
        ...
        redirectWay: 'stay'// 认证成功后，页面跳转方式：stay 代表停留当前页、next 代表跳转下一页
    };
    ...
    //防蹭网
    //_state.hasAutoAuth
    var oldHasAutoAuth = _state.hasAutoAuth;
    if(_NET_DEF_SWITCH && _NET_DEF_SWITCH === 'ON'){//开启防蹭网功能
        _state.hideAuthDivStyle = 'hide';//隐藏tab及主体认证组件
        _state.openNetDef = true;//将开关标识设置为开启
        _state.openNetDef = true;//将开关标识设置为开启
        _state.hasAutoAuth = false;//暂时屏蔽自动认证组件，防止请求后端接口，等防蹭网校验通过后恢复至默认值
    }

    //中英文--中文
    var message_cn = {
        //公共
        freeLoginBtnDsp: '登录上网',//免费登录
        reacquire: '重新获取',//重新获取
        ...
        //防蹭网
        netDefCodePlaceholer: '上网密码',//上网密码
        alertInputNetDefCode: '请输入正确的上网密码',//请输入正确的上网密码
        netDefBtnDsp: '确定',//确定
        netDefPromptMsg: '上网密码向商家索取',//上网密码向商家索取

        //手机号认证
        mobileTitle: (_message && _state.language == 'cn') ? _message.mobileTitle : '手机号',//tab标签显示值
        getAuthCodeBtnDsp: '验证码',//获取验证码
        inputCellphonePlaceholder: '手机号',//请输入手机号码
        inputAuthCodePlaceholder: '验证码',//请输入验证码
        ...
        //用户名认证
        userPassTitle: (_message && _state.language == 'cn') ? _message.userPassTitle : '静态用户名',//tab标签显示值
        inputUserNamePlaceholder: ((_message && _state.language == 'cn') ? _message.userPassTitle : '静态用户名'),//请输入静态用户名
        inputPasswordPlaceholder: '密码',//请输入密码

        //语音认证
        voiceTitle: (_message && _state.language == 'cn') ? _message.voiceTitle : '语音',
        voiceSubmitBtn: '点击拨号',
        ...
        //免费上网认证
        freeButtonDsp: (_message && _state.language == 'cn') ? _message.freeButtonDsp : '点击免费上网',//按钮显示值
        autoAuthComponentPrefix: '欢迎您再次访问，',//欢迎您再次访问，
        autoAutheComponentSuffix: '秒',//秒倒计时

        //微信
        wechatBtnDsp: '进入公众号',//进入公众号


        //修改密码--设置新密码
        alertInputOldPassword: '旧密码',//请输入旧密码
        alertInputNewPassword: '新密码',//请输入新密码
        alertInputConfirmPassword: '确认密码',//请输入确认密码
        ...
        //忘记密码--验证手机号
        inputCellphoneConfirmPlaceholder: '手机号',//请输入手机号进行验证
    ...
    var message_en ={
        ...
        //防蹭网
        netDefCodePlaceholer: 'Password',//上网密码
        alertInputNetDefCode: 'Please enter the correct password',//请输入正确的上网密码
        netDefBtnDsp: 'GO',//确定
        netDefPromptMsg: 'Asking for password from shopkeeper',//上网密码向商家索取

        //手机号认证
        mobileTitle: 'Telephone',//tab标签显示值
        getAuthCodeBtnDsp: 'Authcode',//获取验证码
        inputCellphonePlaceholder: 'Phone',//请输入手机号码
        inputAuthCodePlaceholder: 'Authcode',//请输入验证码
        ...
        inputUserNamePlaceholder: 'Username',//请输入静态用户名
        inputPasswordPlaceholder: 'Password',//请输入密码
        ...
        //微信
        wechatBtnDsp: 'Official Accounts',//进入公众号

        //修改密码--设置新密码
        alertInputOldPassword: 'Old password',//请输入旧密码
        alertInputNewPassword: 'New password',//请输入新密码
        alertInputConfirmPassword: 'New password again',//请输入确认密码
        ...
        //忘记密码--验证手机号
        inputCellphoneConfirmPlaceholder: 'Phone',//请输入手机号进行验证
    ...
    //如果用户id[_USER_ID]不为空，说明用户已经进行认证放行，认证组件自动隐藏
    if(_USER_ID && _USER_ID!='{@userId@}'){
        //alert('用户已经进行认证放行');
        _state.hideAuthDivStyle = 'hide';
        _state.hasAutoAuth = false;
        _state.openMessage = false;
    }
    ...
    var netDefCheckchUrl = '/pagesrv/netdef/check';//防蹭网码校验接口地址
    var wechatAttentionFlagUrl = '/pagesrv/wechat/attention';//判断用户是否已关注公众号接口地址
    var callWechatUrl = '/wechat/wechatCertification';//呼起微信接口地址
    var getUserIdUrl = '/pagesrv/user/session/id';//获取session中的userId
    ...
    var AuthComponent = React.createClass({
        getInitialState: function() {//获取实例的初始化状态
            return _state;
        },
        componentWillMount: function() {//组件将要被装载
            refreshUserId(this);//刷新用户id
        },
        //tab点击事件
        handleTabClick: function(e){
            ...
            //选中 手机号认证
            if(tabContent === _message.mobileTitle){
                _state.active = 'mobile';
                _state.display = 'mobile';
            }
            //选中 静态用户名认证
            else if(tabContent === _message.userPassTitle){
                _state.active = 'userPass';
                _state.display = 'userPass';
            }
            //选中 语音认证
            else if(tabContent === _message.voiceTitle){
                _state.active = 'voice';
        ...
        //更新国际化-中文部分内容
        updateMessageCn: function () {
            //手机号认证
            message_cn.mobileTitle = _state.mobileTitle;
            message_cn.inputCellphonePlaceholder = _state.mobileTitle;
            //用户名认证
            message_cn.userPassTitle = _state.userPassTitle;
            message_cn.inputUserNamePlaceholder = _state.userPassTitle;
            //语音认证
            message_cn.voiceTitle = _state.voiceTitle;
            //免费上网认证
            message_cn.freeButtonDsp = _state.freeButtonDsp;
        },
        render: function() {
            /* 设置tab宽度样式 */
            var tabClass = '';
            ...
            this.updateMessageCn();//更新国际化-中文部分内容
            return (
                <div id="authComponentV2-mws-div" className={"_Entity_ " + this.state.style}>
                    <div className={ (this.state.tabNum > 1 ? 'model clearfix ' : '') + (this.state.display=='free' ? 'hide' : '') + ' ' + this.state.hideAuthDivStyle}>
                        { this.state.hasMobile && this.state.tabNum > 1 ? <MobileAuthTabComponent active={ this.state.active } click={ this.handleTabClick } title={ _message.mobileTitle } tabClass={ tabClass } titleFontColor={this.state.titleFontColor} /> : '' }
                        { this.state.hasUserPass && this.state.tabNum > 1 ? <UserPassAuthTabComponent active={ this.state.active } click={ this.handleTabClick } title={ _message.userPassTitle } tabClass={ tabClass } titleFontColor={this.state.titleFontColor} /> : '' }
                        { this.state.hasVoice && this.state.tabNum > 1 ? <VoiceAuthTabComponent active={ this.state.active } click={ this.handleTabClick } title={ _message.voiceTitle } tabClass={ tabClass } titleFontColor={this.state.titleFontColor} /> : '' }
                    </div>
                    ...
                    <div className={ 'forms clearfix ' + this.state.hideAuthDivStyle }>
                        { this.state.hasFree && this.state.display == 'free' ?
                            (_state.hasAutoAuth ?
                                ...
                                <FreeAuthComponent buttonDsp={ _message.freeButtonDsp } setAuthState={ this.setAuthState } />)
                            : '' }
                    ...
                    { this.state.openNetDef ? <NetDefComponent setAuthState={ this.setAuthState } /> : '' }
                    { this.state.hasWechat ? <WechatComponent setAuthState={ this.setAuthState } /> : '' }
                </div>
            );
        }
    });
    ...
    var MobileAuthComponent = React.createClass({
        second: 60,// 倒计时
        option: {
            getAuthCodeBtnDsp: _message.getAuthCodeBtnDsp,//获取验证码 按钮显示值
        ...
        getAuthCode: function(eventType){
            ...
            if(_state.openBlacklist){
                ...
                if(mobile === '' || !(/^(1[3|4|5|7|8][0-9][0-9]{8})?$/).test(mobile)){
                    alert(_message.alertInputCellphone);//请输入正确的手机号码
                    return;
                }
                //3.发送短信验证码
        ...
        sendAuthCode: function(){
            ...
            this.option.getAuthCodeBtnDsp = _message.reacquire + '(' + leftTime + ')';//重新获取
            ...
            var timer = setInterval(function(){
                if(leftTime <= 0){
                    ...
                    _this.option.getAuthCodeBtnDsp = _message.getAuthCodeBtnDsp;//获取验证码
                    _this.setState(_this.option);
                    return;
                }
                _this.option.getAuthCodeBtnDsp = _message.reacquire + '(' + leftTime + ')';//重新获取
                _this.setState(_this.option);
                leftTime --;
            }, 1000);
        ...
        handleLogin: function(eventType){
            ...
            if(_DISCLAIMER === 'refuse'){// 判断免责声明
                alert(_message.alertAgreeDisclaimer);//请先同意免责声明
                return;
            }
            var mobile = this.state.mobile;//手机号
            ...
            if(authCode === '' || !(/^[0-9]{4}$|^[0-9]{6}$/).test(authCode)){
                alert(_message.alertInputAuthCode);//请输入正确的验证码
                return;
            }
        ...
        render: function() {
            ...
            if(curGetAuthCodeBtnDsp === message_cn.getAuthCodeBtnDsp || curGetAuthCodeBtnDsp  === message_en.getAuthCodeBtnDsp){
                this.state.getAuthCodeBtnDsp = _message.getAuthCodeBtnDsp;
            }
            return (
                <div className={ 'form-item qrcode' + (this.props.display=='mobile' ? ' show' : ' hide') }>
                    ...
                    <div className="input-control">
                        ...
                        <input type="text" onChange={ this.handleMobileChange } value={ this.state.mobile } placeholder={ _message.inputCellphonePlaceholder } />
                    </div>
                    <div className="input-control">
                        <em className="icon-lock"></em>
                        <input type="text" onChange={ this.handleAuthCodeChange } value={ this.state.authCode } placeholder={ _message.inputAuthCodePlaceholder } />
                    ...
                    <div className="btn-login">
                        <input type="button" value={ _message.freeLoginBtnDsp } className={ this.props.mobileLoginBtnSty + ' ' + this.state.loginBtnSty } disabled={ this.state.loginDisabled }
    ...
    var UserPassAuthComponent = React.createClass({
        ...
        handleLoginClick: function(eventType){
            ...
            if(userName === ''){
                alert(_message.inputUserNamePlaceholder);//请输入用户名
                return;
            }
            if(password === ''){
                alert(_message.inputPasswordPlaceholder);//请输入密码
                return;
            }
            this.disabledButton();//登录按钮变灰
            ...
            return (
                <div className={ 'form-item ' + (this.props.display=='userPass' ? 'show' : 'hide') }>
                    <div className="input-control resetPadding">
                        <input type="text" value={ this.state.userName } onChange={ this.handleUserNameChange } placeholder={ _message.inputUserNamePlaceholder } />
                    </div>
                    <div className="input-control resetPadding">
                        <input type="password" value={ this.state.password } onChange={ this.handlePasswordChange } placeholder={ _message.inputPasswordPlaceholder } />
                        <input type="button" onClick={ this.handleLoginClick.bind(this, 'click') } onTouchStart={ this.handleLoginClick.bind(this, 'touch') } className={ this.state.loginBtnSty } disabled={ this.state.loginDisabled } value={ _message.freeLoginBtnDsp } />
                    </div>
                    <div className="optArea">
                        <span className={this.state.hasModefiyPassword ? '' : 'hide'} style={ this.props.titleFontColor ? {color: this.props.titleFontColor} : {} }
                              onClick={ this.handModifyPassword.bind(this, 'click') } onTouchStart={ this.handModifyPassword.bind(this, 'touch') } >{ _message.modifyPassword }</span>
                        ...
                        <span className={this.state.hasForgetPassword ? '' : 'hide'} style={ this.props.titleFontColor ? {color: this.props.titleFontColor} : {} }
                              onClick={ this.handForgetPassword.bind(this, 'click') } onTouchStart={ this.handForgetPassword.bind(this, 'touch') } >{ _message.forgetPassword }</span>
                    </div>
                </div>
            );
        }
    ...
    var VoiceAuthComponent = React.createClass({
        ...
        timer: null,//倒计时-对象
        option: {
            loginBtnDsp: _message.voiceSubmitBtn,//获取验证码 按钮显示值
            loginBtnSty: '',//登录按钮样式
            loginDisabled: '',//登录按钮变disabled
            country_list: {
        ...
        resetTimeInterval: function(){
            ...
            this.option.loginDisabled = '';
            this.option.loginBtnSty = '';
            this.option.loginBtnDsp = _message.voiceSubmitBtn;//点击拨号
            this.setState(this.option);
        },
        //点击拨号 事件
        handleLogin: function(eventType){
            ...
            var mobile = _this.state.mobile;//手机号
            if(mobile === ''){
                alert(_message.inputCellphonePlaceholder);//请输入手机号码
                return;
            }
            if(!(/^[0-9]\d*/).test(mobile)){
                alert(_message.alertIVRCellphoneCheck);//手机号码只能是数字
                return;
            }
            var leftTime = _this.second;//剩余时间
            this.option.loginBtnSty = 'disaButton';
            this.option.loginDisabled = 'disabled';
            this.option.loginBtnDsp = _message.voiceSubmitBtn + '(' + leftTime + ')';//点击拨号
            _this.setState(this.option);
            leftTime --;
            _this.timer = setInterval(function(){
                if(leftTime <= 0){
                    ...
                    _this.option.loginBtnDsp = _message.voiceSubmitBtn;//点击拨号
                    _this.setState(_this.option);
                    return;
                }
                _this.option.loginBtnDsp = _message.voiceSubmitBtn + '(' + leftTime + ')';//点击拨号
                _this.setState(_this.option);
                leftTime --;
            }, 1000);
        ...
        render: function() {
            ...
            if(curLoginBtnDsp === message_cn.voiceSubmitBtn || curLoginBtnDsp  === message_en.voiceSubmitBtn){
                this.state.loginBtnDsp = _message.voiceSubmitBtn;
            }
            //循环生成国家编号
            var options = [];
            ...
            return (
                <div className={ 'form-item ' + (this.props.display=='voice' ? 'show' : 'hide') }>
                    ...
                    <div className="input-control resetPadding">
                        <input type="text" value={ this.state.mobile } onChange={ this.handleMobileChange } placeholder={ _message.inputCellphonePlaceholder }/>
                    </div>
                    <div className="btn-login">
                        <input type="button" className={ this.state.loginBtnSty } disabled={ this.state.loginDisabled } value={ this.state.loginBtnDsp }
                               onClick={ this.handleLogin.bind(this, 'click') } onTouchStart={ this.handleLogin.bind(this, 'touch') } />
                    </div>
                    <div className="voiceMessage" style={ this.props.titleFontColor ? {color: this.props.titleFontColor} : {} } >{ _message.voiceMessage}</div>
                </div>
            );
        }
    });
        ...
        render: function() {
            return (
                <div className="form-item show">
                    ...
                    <div className="changeAuth" onClick={ this.handSwitchAuth.bind(this, 'click') } onTouchStart={ this.handSwitchAuth.bind(this, 'touch') }>{ _message.changeAuthType }</div>
                </div>
            );
        }
    });
        ...
        render: function() {
            return (
                <div className="welcome">
                    <div className={ this.state.autoAuthSty } >{ _message.autoAuthComponentPrefix } <span className="time">{ this.state.second }</span> { _message.autoAutheComponentSuffix }</div>
    ...
    var ModifyPasswordForSetNewPasswordComponent = React.createClass({
        ...
        handleSubmit: function(eventType){
            ...
            if(oldPassword === ''){
                alert(_message.alertInputOldPassword);//请输入旧密码
                return;
            }
            var newPassword = this.state.newPassword;//新密码
            if(newPassword === ''){
                alert(_message.alertInputNewPassword);//请输入新密码
                return;
            }
            if(!(/^[^\u4e00-\u9fa5]{4,20}$/).test(newPassword)){
                alert(_message.alertCheckPassword);//新密码必须由4-20位不包含汉字的字符组成！
                return;
            }
            if(oldPassword === newPassword){
                alert(_message.alertCheckPasswordSame);//旧密码与新密码不允许相同，请重新输入！
                return;
            }
            var confirmPassword = this.state.confirmPassword;//确认密码
            if(confirmPassword === ''){
                alert(_message.alertInputConfirmPassword);//请输入确认密码
                return;
            }
            if(!(/^[^\u4e00-\u9fa5]{4,20}$/).test(confirmPassword)){
                alert(_message.alertCheckConfirmPassword);//确认密码必须由4-20位不包含汉字的字符组成！
                return;
            }
            if(newPassword != confirmPassword){
                alert(_message.alertCheckNewConfirmPasswordSame);//新密码与确认密码不一致，请重新输入！
                return;
            }
            this.disabledButton();//登录按钮变灰
        ...
        render: function() {
            return (
                <div className="forms clearfix">
                    <div className="form-item show">
                        <div className="input-control resetPadding">
                            <input type="text" value={ this.state.userName } placeholder={ _message.inputUserNamePlaceholder } onChange={ this.handleUserNameChange } />
                        </div>
                        <div className="input-control resetPadding">
                            <input type="password" value={ this.state.oldPassword } placeholder={ _message.alertInputOldPassword } onChange={ this.handleOldPasswordChange } />
                        </div>
                        <div className="input-control resetPadding">
                            <input type="password" value={ this.state.newPassword } placeholder={ _message.alertInputNewPassword } onChange={ this.handleNewPasswordChange } />
                        </div>
                        <div className="input-control resetPadding">
                            <input type="password" value={ this.state.confirmPassword } placeholder={ _message.alertInputConfirmPassword } onChange={ this.handleConfirmPasswordChange } />
                            <input type="button" value={ _message.submitBtn } className={ 'submit ' + this.state.loginBtnSty } disabled={ this.state.loginDisabled }
                                   onClick={ this.handleSubmit.bind(this, 'click') } onTouchStart={ this.handleSubmit.bind(this, 'touch') } />
                            <input type="button" className="cancel" value={ _message.cancelBtn } onClick={ this.handleCancel.bind(this, 'click') } onTouchStart={ this.handleCancel.bind(this, 'touch') } />
                        </div>
                    </div>
                </div>
            );
        ...
        render: function() {
            ...
            return (
                <div className="forms clearfix">
                    <div className="form-item show">
                        <div className="input-control resetPadding">
                            <input type="text" value={ this.state.mobile } placeholder={ _message.inputCellphoneConfirmPlaceholder } onChange={ this.handleMobileChange } />
                        ...
                        <div className="input-control resetPadding">
                            <input type="text" value={ this.state.authCode } placeholder={ _message.inputAuthCodePlaceholder } onChange={ this.handleAuthCodeChange } />
                            <input type="button" value={ _message.submitBtn } className={ 'submit ' + this.state.loginBtnSty } disabled={ this.state.loginDisabled }
                                   onClick={ this.handleSubmit.bind(this, 'click') } onTouchStart={ this.handleSubmit.bind(this, 'touch') } />
                            <input type="button" className="cancel" value={ _message.cancelBtn } onClick={ this.handleCancel.bind(this, 'click') } onTouchStart={ this.handleCancel.bind(this, 'touch') } />
                        </div>
            ...
            return (
                <div className="language">
                    <div className={ this.props.display=='voice' ? 'show' : 'hide'}>
                        <div className="helpMessage" onClick={ this.changeLayoutShow.bind(this, 'click') } onTouchStart={ this.changeLayoutShow.bind(this, 'touch') } >{ _message.voiceHelpTitle }</div>
    ...
    var WelcomeComponent = React.createClass({
        ...
        render: function() {
            return (
                <div className="welcome">{ _message.welcomeComponentPrefix } <span className="time">{ this.state.second }</span> { _message.welcomeComponentSuffix }</div>
            );
        }
    });
    ...
    var MessageSendComponent = React.createClass({
        render: function() {
            return (
                <div className="optArea">
                    <div className="operLink"><a href="tel:10690498229982">{ _message.getAuthCodeFailedClick }</a></div>
                    <div className="infoMess">{ _message.getAuthCodeFailedSendMessage }</div>
                </div>
            );
        }
    });
     ...
     * 防蹭网组件
     */
    var NetDefComponent = React.createClass({
        option: {
            netDefSty: '',//防蹭网码-显示/隐藏样式
            loginBtnSty: '',//登录按钮样式
            loginDisabled: '',//登录按钮变disabled
            netDefCode: '' //防蹭网码
        },
        ...
        //防蹭网码输入框change事件
        handleNetDefCodeChange : function(e){
            this.option.netDefCode = e.target.value;
            this.setState(this.option);
        },
        //登录按钮变灰
        disabledButton: function(){
        ...
        handleLoginClick: function(eventType){
            ...
            var netDefCode = this.state.netDefCode;//防蹭网码
            if(!netDefCode){
                alert(_message.alertInputNetDefCode);//请输入正确的上网密码
                return;
            }
            this.disabledButton();//登录按钮变灰
            netDefCheck(netDefCode, this);//调用防蹭网码校验接口
        },
        render: function() {
            return (
                <div className={ 'forms clearfix ' + this.state.netDefSty }>
                    <div className="form-item netDef show">
                        <div className="input-control resetPadding">
                            <input type="text" value={ this.state.netDefCode } onChange={ this.handleNetDefCodeChange } placeholder={ _message.netDefCodePlaceholer } />
                            <input type="button" onClick={ this.handleLoginClick.bind(this, 'click') } onTouchStart={ this.handleLoginClick.bind(this, 'touch') }
                                   className={ this.state.loginBtnSty + ' netDefBtn' } style={{ width: '71px' }}
                                   disabled={ this.state.loginDisabled } value={ _message.netDefBtnDsp } />
                            <div className="netDefPromptMsg">*{ _message.netDefPromptMsg }</div>
                        </div>
                    </div>
                </div>
            );
     ...
     * 微信组件
     */
    var WechatComponent = React.createClass({
        option: {
            wechatSty: '',//微信-显示/隐藏样式
            loginBtnSty: '',//登录按钮样式
            loginDisabled: ''//登录按钮变disabled
        },
        getInitialState: function() {
        ...
        render: function() {
            return (
                <div className={ 'form-item wechat ' + this.state.wechatSty } >
                    <div className={ 'forms clearfix '}>
                        <div className="btn-login">
                            <input type="button"  onClick={ this.handleLoginClick.bind(this, 'click') } onTouchStart={ this.handleLoginClick.bind(this, 'touch') }
                                   className={ this.state.loginBtnSty } disabled={ this.state.loginDisabled }
                                   value={ _message.wechatBtnDsp } />
                            <div className="msg">关注商户微信公众号即可上网</div>
                        </div>
                    </div>
                </div>
            );
     ...
     * 微信页面跳转
     */
    function wechatRedirect(_this) {
        getWechatAttentionFlag(_this);
    }
     ...
     */
    function redirect(){
        if(_state.redirectWay && _state.redirectWay === 'stay'){
            $('#authComponentV2-mws-div').hide("slow");
            return;
        }
        var url = '/site?';
        ...
        //用户信息
        url += appendURLParam('user_id', _USER_ID);//用户id
    ...
    function fatAPAuth(token, _this){
        ...
        var time = 0;//用于控制success、error、complete 3个只执行一次
        $.ajax({
            url: url,
            dataType: 'jsonp',
            jsonp: 'callback',
            ...
            //async:false,//true 异步(默认)、false 同步
            success:function(data, textStatus, jqXHR){
                if(time > 0){ return; }else { time ++; }//用于控制success、error、complete 3个只执行一次
                try{
                    wechatRedirect(_this);//页面跳转
                }catch(e){
                    //_this.setState({loginDisabled: '', loginBtnSty: ''});//登录按钮恢复
    ...
    function modifyPwd(userName, oldPassword, newPassword, confirmPassword, _this){
        ...
        $.ajax({
            ...
            success:function(data, textStatus, jqXHR){
                if(data.result === 'OK'){//接口执行成功
                    alert(_message.alertPasswordSuccess);//密码修改成功，请使用新密码重新登陆！
            ...
            error: function(XHR, textStatus, errorThrown) {
                alert(_message.alertPasswordFail);//密码修改失败！
                _this.enableButton();//登录按钮恢复
            },
            complete: function(XHR, textStatus){
    ...
    function sendAuthcode(mobile, _this){
        ...
        $.ajax({
            ...
            error: function(XHR, textStatus, errorThrown) {
                alert(_message.alertSendAuthCodeFail);//验证码发送失败！
            },
            complete: function(XHR, textStatus){
                _this.setState({loginDisabled: '', loginBtnSty: ''});//登录按钮恢复
            }
    ...
    function checkAuthcode(mobile, authCode, _this){
        ...
        $.ajax({
            ...
            error: function(XHR, textStatus, errorThrown) {
                alert(_message.alertAuthCodeCheckFail);//验证码校验失败！
                _this.enableButton();//登录按钮恢复
            },
            complete: function(XHR, textStatus){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data.isBlacklist == 'yes'){
                    alert(_message.alertBlacklistCheckFail);//您无法使用该网络，请与管理员联系。
                }else{
                    func();
                }
            },
    ...
    /**
     * 通过deviceId校验防蹭网码是否正确
     * @param netDefCode 防蹭网码
     * @param _this this
     */
    function netDefCheck(netDefCode, _this){
        if(_DEV_ID == '{@devId@}'){
            return;
        }
        var option ={
            deviceId: _DEV_ID,//设备id
            netDefCode: netDefCode //防蹭网码
        };
        var params = 'params=' + encodeURIComponent(JSON.stringify(option));
        $.ajax({
            url: netDefCheckchUrl,
            type: 'GET',
            dataType: 'JSON',
            header: {
                'cache-control': 'no-cache'
            ...
            success: function (data) {
                ...
                _state.hideAuthDivStyle = '';
                //2.隐藏防蹭网
                _this.state.netDefSty = 'hide';
                //3.恢复自动认证组件原始状态
                _state.hasAutoAuth = oldHasAutoAuth;
                //4.更新Auth组件状态
    ...
    /**
     * 通过商户id、用户MAC获取微信关注标识
     * @param _this this
     */
    function getWechatAttentionFlag(_this){
        if(_DEV_ID == '{@devId@}'){
            return;
        }
        var option ={
        ...
        $.ajax({
            ...
            success: function (data) {
                var code = data.code;
                //情况一：商户未开通微信应用，页面跳转，流程结束
                if(code === 'E2700006'){ redirect(); return;}
                //情况二：“该商户尚未关联公众号，请先联系商户关联公众号！”，显示"进入公众号"按钮
                else if (code === 'E2700003'){
                    //显示认证主组件内容
                    _state.hideAuthDivStyle = 'hide';
                    //显示微信组件
                    _state.hasWechat = true;
                    _this.props.setAuthState();
                }
                //其它接口失败情况，提示异常
                else if (code != '0') {
                    alert(data.msg);//提示错误信息
                    _this.enableButton();//恢复按钮
                    return;
                }
                var attentionFlag = data.data.attentionFlag;//关注标识：-1 未关注、1 已关注
                if(attentionFlag === -1) {//未关注
                    //显示认证主组件内容
                    _state.hideAuthDivStyle = 'hide';
                    //显示微信组件
                    _state.hasWechat = true;
                    _this.props.setAuthState();
                } else if (attentionFlag === 1) {//已关注
                    redirect();
                    return;
                } else {
                    alert('关注标识[' + attentionFlag + ']超出了范围[-1|1]！');
                }
            },
            error: function (xhr, textStatus) {
                alert(textStatus || '系统异常，请稍后再试...');
    ...
    /**
     * 因页面跳转导致userId丢失，需要重新刷新，但只允许执行一次
     * @param _this this
     */
    var refreshUserIdTime = 0;
    function refreshUserId(_this){
        if(_DEV_ID == '{@devId@}'){
            return;
        }
        if(_USER_ID != ''){//_USER_ID为空时 流程结束
            return;
        }
        if(refreshUserIdTime > 0){//用于控制只允许执行一次
            return;
        }
        var params = '';
        var url = getUserIdUrl + '?t=' + new Date().getTime();
        $.ajax({
            url: url,
            type: 'GET',
            dataType: 'JSON',
            ...
            success: function (data) {
                ...
                var userId = data.data.userId;//用户id
                if(!userId || userId === ''){
                    return;
                }
                _USER_ID = userId;
    ...
    function formatSMSError(message){
        if(message == null || message == undefined){
            alert(_message.alertGetAuthCodeFail);//抱歉，获取验证码失败.
        }else if(message == 'sms_code_sended'){
            alert(_message.alertCheckAuthCodeSended);//抱歉，验证码发送过于频繁，您可使用获取的验证码认证上网.
        }else if(message == '接口无返回值！' || message == '接口返回值不允许为空！'){
            alert(_message.alertAuthCodeNoResponse);//抱歉，获取验证码失败（错误信息：接口无响应）
        }else{
            if(message.length >= 30){
                message = message.substring(0,30) + '......';
            }
            alert(_message.alertSorryAuthCodeCheckFail + message +'）');//抱歉，获取验证码失败（错误信息：
        }
    }
    ...
    function formatAuthError(message){
        if(message == null || message == undefined){
            alert(_message.alertAuthFail);//抱歉，认证失败.
        }else if(message == 'sms_code_error'){
            alert(_message.alertAuthCodeError);//抱歉，验证码校验失败，请重新输入.
        }else if(message == 'sms_code_expired'){
            alert(_message.alertAuthCodeExpired);//抱歉，验证码已失效，请重新获取.
        }else if(message == '接口无返回值！' || message == '接口返回值不允许为空！'){
            alert(_message.alertAuthNoResponse);//抱歉，认证失败（错误信息：接口无响应）
        }else if(message == 'duplicate challenge request'){
            alert(_message.alertDuplicateChallengeRequest);//请求处理中，请勿重复认证。
        }else{
            if(message.length >= 30){
                message = message.substring(0,30) + '......';
            }
            alert(_message.alertSorryAuthCheckFail+ message +'）');//抱歉，认证失败（错误信息：
        }
    }
