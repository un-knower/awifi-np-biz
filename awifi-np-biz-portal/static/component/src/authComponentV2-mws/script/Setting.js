...
var _Setting_ = function (entity, divId) {
    ...
    var SettingReact = React.createClass({
        ...
        handleUserPassTitleChange: function(e){
            ...
            //_message.inputUserNamePlaceholder = '请输入' + e.target.value;
            this.setState(_state);
        },
        //是否含tab点击时间处理 -- 语音认证
        handleVoiceTitleChange: function(e){
            _state.voiceTitle = e.target.value;
            this.setState(_state);
        },
        //checkbox点击事件处理
        handleCheckboxClick: function(type, e){
            switch(type){
                ...
                case 'redirectWay': if(e.target.checked){_state.redirectWay='next';}else{_state.redirectWay='stay';}; break;//认证成功后，页面跳转方式
            }
            this.setState(_state);
        },
        //自动登录上网-倒计时秒数-变更事件处理
        ...
        handleSaveClick: function(){
            ...
            //6.如果选中语音认证，则内容不能为空
            if(_state.hasVoice && _state.voiceTitle === ''){
                alert('语音认证标题不允许为空！');
                return;
            }
            //5.设置tabNum数量
                ...
                <div className="_Setting_">
                    <div className="form-group authModelConfig">
                        ...
                        <div className="col-sm-12 mobileArea">
                            ...
                            <input type="text" className="form-control resetInputWidth" value={ _state.mobileTitle } onChange={ this.handleMobileTitleChange } placeholder="请输入手机号认证标题"/>
                            <label className="authTitle">*包括二维码认证</label>
                            <div>
                                <label className="authTitle">登录按钮</label>&nbsp;&nbsp;&nbsp;
                                <label className="authTitle3" title="注：不勾选时，点击获取验证按钮后自动显示">
                                    <input type="checkbox" defaultChecked={ _state.mobileLoginBtnSty === '' } onClick={ this.handleCheckboxClick.bind(this, 'mobileLoginBtnSty') } />&nbsp;显示（勾选显示）
                                </label>
                            </div>
                            {/*屏蔽短信回发功能
                             <div>
                        ...
                        <div className="col-sm-12 typeArea">
                            ...
                            <input type="text" className="form-control resetInputWidth" value={ _state.userPassTitle } onChange={ this.handleUserPassTitleChange } placeholder="请输入用户名认证标题"/>&nbsp;&nbsp;&nbsp;

                            <label className="authTitle">
                                <input type="checkbox" defaultChecked={ _state.hasModefiyPassword } onClick={ this.handleCheckboxClick.bind(this, 'hasModefiyPassword') }/>&nbsp;修改密码
                            </label>&nbsp;&nbsp;

                            <label className="authTitle">
                                <input type="checkbox" defaultChecked={ _state.hasForgetPassword } onClick={ this.handleCheckboxClick.bind(this, 'hasForgetPassword') }/>&nbsp;忘记密码
                            </label>
                        </div>
                        <div className="col-sm-12 typeArea">
                            ...
                            <input type="text" className="form-control" value={ _state.voiceTitle } onChange={ this.handleVoiceTitleChange } placeholder="请输入语音认证标题"/>
                        </div>
                        <div className="col-sm-12 typeArea">
                            ...
                            <input type="text" className="form-control" value={ _state.freeButtonDsp } onChange={ this.handleFreeTitleChange } placeholder="请输入免费上网按钮内容"/>
                            ...
                            <div className="autoLogin">
                                ...
                                <span className={ _state.hasAutoAuth ? '' : 'hide' } >
                                    ...
                                    <select defaultValue={ _state.autoAuthSecond } onChange={ this.handAutoAuthSecondChange } >
                                        ...
                                        <option value="5">5</option>redirecat
                    ...
                    <div className="form-group featuresConfig">
                        ...
                        <div className="col-sm-12 typeArea">
                            <input type="checkbox" id="redirectWayBox" defaultChecked={ _state.redirectWay=='next' } onClick={ this.handleCheckboxClick.bind(this, 'redirectWay') }/>
                            <label className="authTitle" htmlFor="redirectWayBox"
                            >认证成功后跳转方式（勾选跳下一页，不勾选停留隐藏）</label>
                        </div>
