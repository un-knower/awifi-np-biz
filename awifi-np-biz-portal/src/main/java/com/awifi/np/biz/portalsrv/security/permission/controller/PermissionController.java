...
public class PermissionController extends BaseController{
    ...
    public Map<String,Object> check(
        ...
        String serviceCode = SysConfigUtil.getParamValue("servicecode_portal");//服务代码[外键]
        //从redis中获取
    ...
    public Map<String,Object> getCodesByRoleIdForAm(
        ...
        String serviceCode = SysConfigUtil.getParamValue("servicecode_portal");//服务编号
    ...
    public Map<String,Object> pushForAm() throws Exception{
        String serviceCode = SysConfigUtil.getParamValue("servicecode_portal");//从配置表读取服务代码
        String serviceKey = SysConfigUtil.getParamValue("servicekey_portal");//从配置表读取服务密钥
