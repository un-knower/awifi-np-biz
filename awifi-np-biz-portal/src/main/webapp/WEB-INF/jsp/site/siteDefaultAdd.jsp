...
<title>默认站点管理_爱WiFi行业客户Portal平台</title>
...
<section class="s-wrap">
    ...
    <div id="template-list-wrap">
        <h1 class="s-title">请选择模板</h1>

        <ul class="f-list">
            <li id="search-industry">
                <label class="f-label">选择行业</label>
                <div class="f-node">
            ...
            <li>
                ...
                <div id="template-list" class="template-list">
                    <div class="template-item-no">加载模板列表中</div>
...
<script src="<%=request.getContextPath()%>/js/site-default-add.min.js"></script>
</body>
</html>