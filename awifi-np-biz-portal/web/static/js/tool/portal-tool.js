...
var ComponentClass = function () {
    ...
    function apiSave() {
        ...
        var cascadeLabel = $("#merchant").find("option:selected").attr("attr");
        var siteName =$("#site-name").val();
        //window.location.href="http://localhost:2028/static/html/publish.html?siteId=249&merchantId=543265&access_token=AT_NP_BIZ_FBF2D24A20DE4B9D88B4D94AB94557F4";
        // 验证数据
       ...
       //编辑保存接口
         if (siteId && siteId < 0) {
             ...
             console.log(JSON.stringify(templateInfo.data));
             //templateInfo.data =
             //    [
             //        {"pageType":2,"num":1,"pageOperation":"add",
             //            "components":[{"componentId":3,"componentOperation":"add",
             //                "json":{"content":"队车辆管理所","textAlign":"center","fontSize":"16","display":"none","bgColor":"#052082","fontColor":"#f6ebee","height":"","opacity":"1" }
             //            ,"orderNo":"1"}
             //            ]
             //        }
             //    ]
             ...
             var url = 'portalsrv/site/?access_token='+accessToken;
             $.ajax({
                 url: url,
                 type: 'post',
                 data: JSON.stringify(resp_data),
