...
var _Entity_ = function (state, divId) {
        ...
        render: function() {
            ...
            return (
                <div className={"_Entity_ " + this.state.style}>
                    ...
                    { this.state.openMessage ? <MessageComponent setAuthState={ this.setAuthState } display={ this.state.display }/> : '' }
                    <div className={ 'forms clearfix ' + this.state.hideAuthDivStyle }>
                        ...
                        { this.state.hasMobile ? <MobileAuthComponent display={ this.state.display } hasMsgSend={this.state.hasMsgSend } /> : '' }
            ...
            return (
                <div className={ 'form-item ' + (this.props.display=='mobile' ? 'show' : 'hide') }>
                    <div className="input-control">
                        ...
                        <input type="button" disabled={ this.state.getAuthCodeBtnDisabled } className={ this.state.getAuthCodeBtnSty } value={ this.state.getAuthCodeBtnDsp }
                    ...
                    <div className="input-control">
                        ...
                        <input type="button" value={ _state.message.freeLoginBtnDsp } className={ this.state.loginBtnSty } disabled={ this.state.loginDisabled }
            ...
            return (
                <div className={ 'form-item ' + (this.props.display=='userPass' ? 'show' : 'hide') }>
                    ...
                    <div className="input-control">
                        ...
                        <input type="button" className={ this.state.loginBtnSty } disabled={ this.state.loginDisabled } value={ _state.message.freeLoginBtnDsp }
                               onClick={ this.handleLoginClick.bind(this, 'click') } onTouchStart={ this.handleLoginClick.bind(this, 'touch') } />
                    </div>
                    <div className="optArea">
                        <span className={this.state.hasModefiyPassword ? '' : 'hide'} style={ this.props.titleFontColor ? {color: this.props.titleFontColor} : {} }
                              onClick={ this.handModifyPassword.bind(this, 'click') } onTouchStart={ this.handModifyPassword.bind(this, 'touch') }
                        >{ _state.message.modifyPassword }</span>
                        ...
                        <span className={this.state.hasForgetPassword ? '' : 'hide'} style={ this.props.titleFontColor ? {color: this.props.titleFontColor} : {} }
                              onClick={ this.handForgetPassword.bind(this, 'click') } onTouchStart={ this.handForgetPassword.bind(this, 'touch') }
                        >{ _state.message.forgetPassword }</span>
                    </div>
                </div>
            );
        }
                ...
                <div className="forms clearfix">
                    <div className="form-item show">
                        ...
                        <div className="input-control">
                            ...
                            <input type="button" className="cancel" value={ _state.message.cancelBtn }
                                   onClick={ this.handleCancel.bind(this, 'click') } onTouchStart={ this.handleCancel.bind(this, 'touch') }/>
                        </div>
                    </div>
                </div>
            );
        ...
        render: function() {
            return (
                <div className="language">
                    ...
                    <div className={ this.state.language === 'en' ? 'en checked' : 'en' }
                         onClick={ this.setLanguageEn.bind(this, 'click') } onTouchStart={ this.setLanguageEn.bind(this, 'touch') } >EN</div>
                    <div className={ this.state.language === 'cn' ? 'cn checked' : 'cn' }
                         onClick={ this.setLanguageCn.bind(this, 'click') } onTouchStart={ this.setLanguageCn.bind(this, 'touch') } >CN</div>
                </div>
            );
        }
    });
        ...
        $.ajax({
            ...
            success:function(data, textStatus, jqXHR){
                if(data.result === 'OK'){//接口执行成功
                    ...
                    ivrPoll(mobile, resetTimeInterval);//接口三 ： IVR语音认证-放行轮询接口
     ...
     * @param mobile 手机号
     */
    function ivrPoll(mobile, resetTimeInterval){
        //如果重复调用，先清除上一次timer
