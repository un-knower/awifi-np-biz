package com.awifi.np.biz.eagleeyesrv.security.permission.controller;
...
public class PermissionController extends BaseController{
    ...
    public Map<String,Object> check(
        ...
        String serviceCode = SysConfigUtil.getParamValue("servicecode_eagleeye");//服务代码[外键]
        //从redis中获取
    ...
    public Map<String,Object> getCodesByRoleIdForAm(
        ...
        String serviceCode = SysConfigUtil.getParamValue("servicecode_eagleeye");//服务编号
    ...
    public Map<String,Object> pushForAm() throws Exception{
        String serviceCode = SysConfigUtil.getParamValue("servicecode_eagleeye");//从配置表读取服务代码
        String serviceKey = SysConfigUtil.getParamValue("servicekey_eagleeye");//从配置表读取服务密钥
